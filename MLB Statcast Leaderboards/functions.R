statcast_exit_velo_barrels <- function(year, player_type, min_pa = "q")
{
...
statcast_xstat <- function(year, player_type, min_pa = "q")
{
  if (player_type %in% c("batter","pitcher"))
  {
...
statcast_outs_above_average <- function(year, fielding_type, min_field)
{
  season <- year
