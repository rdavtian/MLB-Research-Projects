...
fg_hitters <- fg_bat_leaders(x = start_year, y = end_year, league = "all", qual = 75, ind = 1)
...
fg_pitchers <- fg_pitch_leaders(x = start_year, y = end_year, league = "all", qual = 50, ind = 1)
